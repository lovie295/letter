...
const DEMO_TREASURE_LETTER = {
  ...
  sender_name: 'Rin',
  message:
    '今日はちゃんと立ち止まって、言葉を残してみました。少し先で読み返したときに、この日のやわらかい気持ちまで思い出せますように。\n\n最近は、毎日が思っていたよりも速く過ぎていく気がしています。目の前のことをひとつずつこなしているうちに、季節まで静かに移り変わってしまって、あとから振り返ってはじめて「あの時ちゃんと感じていたかな」と考えることが増えました。\n\nそれでも、たしかに覚えていたい瞬間があります。夕方のやわらかい光、湯気の立つマグカップ、少し疲れているのに誰かの言葉でふっと救われたこと。そういう小さなことが、私の一日をちゃんと支えていたのだと思います。\n\nうまくいかない日があっても、焦らなくて大丈夫。遠回りに見える時間も、たぶんあとから見れば必要な余白だったとわかる気がします。何かを急いで証明しなくても、あなたの歩幅で進んでいけばいい。\n\nもしこの手紙を未来で読み返していたら、そのときのあなたが少しだけ深呼吸できますように。今日の気持ちは、たしかにここに置いておきます。',
